...
FormlyFormBuilder.ɵfac = function FormlyFormBuilder_Factory(t) { return new (t || FormlyFormBuilder)(ɵngcc0.ɵɵinject(FormlyConfig), ɵngcc0.ɵɵinject(ComponentFactoryResolver), ɵngcc0.ɵɵinject(Injector)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(FormlyFormBuilder, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: FormlyConfig }, { type: ComponentFactoryResolver }, { type: Injector }]; }, null); })();
...
FormlyForm.ɵfac = function FormlyForm_Factory(t) { return new (t || FormlyForm)(ɵngcc0.ɵɵdirectiveInject(FormlyFormBuilder), ɵngcc0.ɵɵdirectiveInject(FormlyConfig), ɵngcc0.ɵɵdirectiveInject(NgZone), ɵngcc0.ɵɵinjectAttribute('immutable'), ɵngcc0.ɵɵdirectiveInject(FormGroupDirective, 8)); };
FormlyForm.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: FormlyForm, selectors: [["formly-form"]], viewQuery: function FormlyForm_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: function () { return [ɵngcc1.NgForOf, FormlyField]; }, encapsulation: 2 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(FormlyForm, [{
  ...
  `,
    ...
    }], function () { return [{ type: FormlyFormBuilder }, { type: FormlyConfig }, { type: NgZone }, { type: undefined, decorators: [{
                type: Attribute,
                args: ['immutable']
...
FormlyField.ɵfac = function FormlyField_Factory(t) { return new (t || FormlyField)(ɵngcc0.ɵɵdirectiveInject(FormlyConfig), ɵngcc0.ɵɵdirectiveInject(Renderer2), ɵngcc0.ɵɵdirectiveInject(ComponentFactoryResolver), ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵinjectAttribute('hide-deprecation')); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(FormlyField, [{
    ...
    }], function () { return [{ type: FormlyConfig }, { type: Renderer2 }, { type: ComponentFactoryResolver }, { type: ElementRef }, { type: undefined, decorators: [{
                type: Attribute,
...
FormlyAttributes.ɵfac = function FormlyAttributes_Factory(t) { return new (t || FormlyAttributes)(ɵngcc0.ɵɵdirectiveInject(Renderer2), ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(DOCUMENT)); };
...
FormlyGroup.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: FormlyGroup, selectors: [["formly-group"]], hostVars: 2, hostBindings: function FormlyGroup_HostBindings(rf, ctx) { if (rf & 2) {
    ...
    } }, directives: [ɵngcc1.NgForOf, FormlyField], encapsulation: 2 });
...
FormlyValidationMessage.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: FormlyValidationMessage, selectors: [["formly-validation-message"]], inputs: { field: "field" }, features: [ɵngcc0.ɵɵNgOnChangesFeature], decls: 2, vars: 3, template: function FormlyValidationMessage_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, pipes: [ɵngcc1.AsyncPipe], encapsulation: 2, changeDetection: 0 });
/** @nocollapse */
...
FormlyTemplateType.ɵfac = function FormlyTemplateType_Factory(t) { return new (t || FormlyTemplateType)(ɵngcc0.ɵɵdirectiveInject(DomSanitizer)); };
